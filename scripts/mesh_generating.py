...
def mesh_creator(fine_bed_path, fine_surf_path, coarse_bed_path, coarse_surf_path, coarse_resamp_factor=1/200, fine_resamp_factor=1/10, layers=15):
    ...
    for src_bed_path, src_surf_path, resamp_factor in zip([coarse_bed_path, fine_bed_path], [coarse_surf_path,fine_surf_path], [coarse_resamp_factor, fine_resamp_factor]):
        ...
        meshes_to_output.append(mesh_src)

    return meshes_to_output